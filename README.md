...
-   [Shadcn Studio](https://shadcnstudio.com/) [![Repo Star](https://img.shields.io/github/stars/shadcnstudio/shadcn-studio.svg?label=&style=social)](https://github.com/shadcnstudio/shadcn-studio) open-source collection of copy-and-paste shadcn components, blocks, and templates - paired with a powerful theme generator & AI Tools to craft, customize, and ship faster.
